...
if __name__ == "__main__":
    ...
    epochs=100
    batch_size=32
    model = train(model_path,data,epochs=epochs,batch_size=batch_size,optimizer=keras.optimizers.Adam(1e-3),loss="binary_crossentropy")

    # accuracy check
    # evolutation_function(model_path,data[0],data[1])
     
    prediction_function(data[0][0],model)
